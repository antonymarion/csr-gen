...
module.exports = function (domain, options, callback) {
    ...
    if (!_.endsWith(options.outputDir, '/')) options.outputDir = path.join(options.outputDir, '/');
    ...
    //         if (err) {
    //             console.log("Error saving password to temp file: " + err);
    //         }
    //     });
    //     opts.push('-passout');
    ...
    console.log("running cmd:", 'openssl', opts.join(" "));
